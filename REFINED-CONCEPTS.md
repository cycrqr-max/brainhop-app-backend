...
Users take tests that measure brain performance—reaction time, memory, attention, etc.—to track progress and compete. Each test produces a score that:
...
2. **Brain Health Games**
   ...
   * Simple games to measure cognitive skills:

     * Reaction time game
     * Memory challenges
     * Number concentration tasks
     * Sudoku or crossword puzzles
   * Scores feed into the leaderboard.
...
* 🎥 Training video
* 🎥 Instruction video
* 🧠 Explanation of the brain effect
...
* System generates **“Today’s Brain Workout”** automatically:
  1️⃣ Focus exercise
  2️⃣ Breathing regulation
  3️⃣ Cognitive drill
* One-click **Start Training** button.
